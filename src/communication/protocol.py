...
from config.robot_config import SPEED_MIN, SPEED_MAX, STEER_COMMAND_MIN, STEER_COMMAND_MAX
...
def serialize_command(speed: int, steer: int, action: str, mode: int) -> str:
    ...
    steer_val = _clamp(steer, STEER_COMMAND_MIN, STEER_COMMAND_MAX, "steer")
