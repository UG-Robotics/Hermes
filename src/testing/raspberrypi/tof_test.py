...
Run on the Pi:
    python3 tof_test.py                # auto-detect the ESP32 port
    python3 tof_test.py /dev/ttyUSB0   # force a specific port
    python3 tof_test.py --raw          # dump every raw line (use when nothing decodes)
"""
